...
interface PortfolioData {
  ...
  link: string;  // Fluent, Basic, Conversational
}
...
const PortfolioModal: React.FC<PortfolioModalProps> = ({ portfolio, isOpen, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
        ...
        >
            ...
            >
                ...
                {loading ? <Loader2 className="animate-spin" /> : portfolio ? "Update" : "Add"}
                </span>
            </button>
            </div>
        </div>
