...
export default function ApplicantPage() {
  ...
  const params = useParams(); // { jobId: "123", applicantId: "456" }
    ...
    <DashboardLayout>
      ...
      >
        <div className="w-[557px] h-auto flex flex-col gap-4"> {/* <-- gap between sections */}
          ...
          <div className="flex flex-col justify-center gap-[10px] w-[557px] h-[146px]">
            <h1 className="font-barlow font-extrabold text-[40px] leading-[64px] text-[#1E1E1E] w-[557px] h-[64px] ">
              {applicant ? applicant.name : applicantId}
            </h1>
           <p className="font-publicSans text-[16px] leading-[24px] text-[#1E1E1E] w-[557px] h-[72px]">
            {applicant 
        ...
        <h3 className="font-barlow font-bold text-[24px] text-[#1E1E1E] mb-6">
          Skills
        </h3>
